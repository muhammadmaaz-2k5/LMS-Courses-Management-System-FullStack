...
const Hero = () => {
  ...
  In Development mode
      ...
      courses designed <span className='text-green-600'> to fit your choice. </span> <img src={assets.sketch} alt="sketch" className='md:block hidden absolute -bottom-7 right-0' /></h1>
